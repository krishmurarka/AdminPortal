    ...
    signin(this.state.username,
      ...
      .then(
        () => {
          ...
          alert('Success with username -> ',this.state.username)
        }
      ).catch(error => {
        alert('Login Error with username -> ',this.state.username)
                                          ...
                                          >
                                            ...
                                            <div class="eael-lr-form-group">
                                              ...
                                              <div class="eael-lr-password-wrapper">
                                                ...
                                                <input type="password" name="password" className="eael-lr-form-control" id="password" value={this.state.password} placeholder="Password" onChange={this.changeHandler} required />
                                                <button
                                                  type="button"
                                                  id="wp-hide-pw"
